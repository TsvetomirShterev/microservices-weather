...
public class WeatherReportAggregator : IWeatherReportAggregator
{
    ...
    public async Task<WeatherReport> BuildReport(string zip, int days)
    {
        ...
        _logger.LogInformation($"zip: {zip} over last {days} days: " +
            $"lo temp: {averageLowTemp}, rain: {averageHighTemp}");
    ...
    {
        var tempServiceProtocol = _weatherDataConfig.PrecipDataProtocol;

        var tempServiceHost = _weatherDataConfig.PrecipDataHost;

        var tempServicePort = _weatherDataConfig.PrecipDataPort;
